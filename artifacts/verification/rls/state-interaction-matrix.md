...
| Startup controls | Wait 7 seconds | Step 2–4 interactions become available, matching the Ceros on-view trigger | PASS |
...
| Production | Build and server-render `/rls` | Route renders with native SVG markup and no Ceros runtime reference | PASS |
